...
> O Partência é um projeto desenvolvido para disciplina de programação web Front-End, o projeto é um ecossistema web colaborativo focado no mapeamento e na conexão direta de monitorias estudantis, projetado para transformar o compartilhamento de conhecimento no ambiente universitário.
<div align="left">
...
├── .gitignore
├── favicon.ico
├── index.html                 # Página de Autenticação (Login) e Cadastro de Usuários/Perfis
├── landingPage.html           # Página Principal (Mural de Monitores, Banner Sobre e Filtros)
├── css/
│   ├── footer.css             # Estilização exclusiva do rodapé da aplicação
│   ├── header.css             # Estilização do menu superior e elementos de navegação
│   ├── main-index.css         # Estilos específicos da tela de Login/Cadastro
│   ├── main-landingPage.css   # Estilos específicos do painel principal (Mural e duas colunas)
│   ├── styles.css             # Arquivo centralizador/global de estilos do projeto
│   └── variables.css          # Design System (Definição de cores ODS 4 em Hexadecimal e fontes)
└── imagens/
    ├── logo.svg               # Vetor do logotipo oficial do projeto Partência
    ├── student.svg            # Vetor ilustrativo da identidade do projeto
    └── favicon/               # Pacote de ícones de resolução para navegadores e dispositivos
        ├── favicon.svg
        ├── favicon16.png
        ├── favicon32.png
        └── favicon180.png
